...
void Tile::spawnWalls(int up, int left, int down, int right)
{
    ...
    //int numRooms = rand() % 9 + 1;
    int numRooms = rand() % 2 + 2;
    int dir = rand() % 2;
    if (numRooms == 1)
    {
        //no walls
        ...
        if (numRooms < 4)
        {
            ...
            switch (sp)
            {
                case 0:
                {
                    if (dir == 0)
                    {
                        createWallRow(0, sf::Vector2i(6,6));
                        createWallRow(3, sf::Vector2i(6, 6));
                    }
                    else
                    {
                        createWallRow(1, sf::Vector2i(6, 6));
                        createWallRow(4, sf::Vector2i(6, 6));
                    }
                    break;
                }
                case 1:
                {
                    if (dir == 0)
                    {
                        createWallRow(1, sf::Vector2i(6, 13));
                        createWallRow(4, sf::Vector2i(6, 13));
                    }
                    else
                    {
                        createWallRow(0, sf::Vector2i(6, 13));
                        createWallRow(3, sf::Vector2i(6, 13));
                    }
                    break;
                }
                case 2:
                {
                    if (dir == 0)
                    {
                        createWallRow(1, sf::Vector2i(13, 6));
                        createWallRow(4, sf::Vector2i(13, 6));
                    }
                    else
                    {
                        createWallRow(0, sf::Vector2i(13, 6));
                        createWallRow(3, sf::Vector2i(13, 6));
                    }
                    break;
                }
                case 3:
                {
                    if (dir == 0)
                    {
                        createWallRow(0, sf::Vector2i(13, 13));
                        createWallRow(3, sf::Vector2i(13, 13));
                    }
                    else
                    {
                        createWallRow(1, sf::Vector2i(13, 13));
                        createWallRow(4, sf::Vector2i(13, 13));
                    }
                    break;
                }
                default:
...
void Tile::createWallRow(int dir, sf::Vector2i index)
{
    switch (dir)
    {
        case 0: //up
        {
            if (index.y >= 0)
            {
                ...
                wall.setPosition(sf::Vector2f(
                    ...
                    hitbox.getPosition().y - hitbox.getSize().y / 2 + hitbox.getSize().y / 40 + hitbox.getSize().y / 20 * (index.y)
                ));
                walls[index.x][index.y] = wall;
                wallsToDraw.push_back(sf::Vector2i(index.x, index.y));
                int dir2 = rand() % 3;
                switch (dir2)
                {
                    case 0: //up
                    {
                        for (int i = 0; i < nonEmptyWalls.size(); i++)
                        {
                            ...
                            {
                                createWallRow(0, sf::Vector2i(index.x, index.y - 1));
                            }
                        }
                        break;
                    }
                    case 1: //left
                    {
                        for (int i = 0; i < nonEmptyWalls.size(); i++)
                        {
                            if (index.x == nonEmptyWalls[i].x - 1 and index.y == nonEmptyWalls[i].y)
                            {
                                break;
                            }
                            if (i == nonEmptyWalls.size() - 1)
                            {
                                createWallRow(1, sf::Vector2i(index.x - 1, index.y));
                            }
                        }
                        break;
                    }
                    case 2: //right
                    {
                        for (int i = 0; i < nonEmptyWalls.size(); i++)
                        {
                            ...
                            if (i == nonEmptyWalls.size() - 1)
                            {
                                createWallRow(3, sf::Vector2i(index.x + 1, index.y));
                            }
                        }
                        break;
                    }
        ...
        case 1: //left
        {
            if (index.x >= 0)
            {
                ...
                case 2: //down
                {
                    for (int i = 0; i < nonEmptyWalls.size(); i++)
                    {
                        if (index.x == nonEmptyWalls[i].x and index.y == nonEmptyWalls[i].y + 1)
                        {
                            break;
                        }
                        if (i == nonEmptyWalls.size() - 1)
                        {
                            createWallRow(2, sf::Vector2i(index.x, index.y + 1));
                        }
                    }
                    break;
                }
            ...
            if (index.y <= 19)
            {
                ...
                case 0: //right
                {
                    for (int i = 0; i < nonEmptyWalls.size(); i++)
                    {
                        ...
                        if (i == nonEmptyWalls.size() - 1)
                        {
                            createWallRow(0, sf::Vector2i(index.x + 1, index.y));
                        }
                    }
                    break;
                }
